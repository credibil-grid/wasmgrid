    ...
    pub mod http {
        ...
        pub mod types {
            ...
            impl Fields {
                ...
                pub fn set(
                    &self, name: &FieldKey, value: &[FieldValue],
                ) -> Result<(), HeaderError> {
                    unsafe {
                        #[repr(align(1))]
                ...
                pub fn set(param: ResponseOutparam, response: Result<OutgoingResponse, ErrorCode>) {
                    unsafe {
                        ...
                        extern "C" {
                            ...
                            fn wit_import(
                                _: i32, _: i32, _: i32, _: i32, _: ::core::mem::MaybeUninit<u64>,
                                _: *mut u8, _: *mut u8, _: usize, _: i32,
                            );
                        }
            ...
            impl OutgoingBody {
                ...
                /// Content-Length.
                pub fn finish(
                    this: OutgoingBody, trailers: Option<Trailers>,
                ) -> Result<(), ErrorCode> {
                    unsafe {
                        #[repr(align(8))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 40]);
...
\x01@\0\0s\x04\0\x13[static]error.trace\x01\x13\x03\x01*wasi:messaging/messaging\
-types@0.2.0-draft\x05\0\x01B\x0a\x04\0\x08pollable\x03\x01\x01h\0\x01@\x01\x04s\
