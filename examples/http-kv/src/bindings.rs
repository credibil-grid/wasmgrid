...
pub mod wasi {
    ...
    pub mod keyvalue {
        ...
        pub mod atomics {
            ...
            ///
            /// If any other error occurs, it returns an `Err(error)`.
            pub fn increment(bucket: &Bucket, key: &str, delta: u64) -> Result<u64, Error> {
                unsafe {
                    #[repr(align(8))]
        ...
        pub mod batch {
                    ...
                    match l3 {
                        ...
                        1 => {
                            let e = {
                                ...
                                use super::super::super::wasi::keyvalue::store::Error as V18;
                                let v18 = match l14 {
                                    0 => V18::NoSuchStore,
                                    1 => V18::AccessDenied,
                                    n => {
            ...
            pub fn set_many(
                bucket: &Bucket, key_values: &[(_rt::String, _rt::Vec<u8>)],
            ) -> Result<(), Error> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                    ...
                    wit_import((bucket).handle() as i32, result3, len3, ptr4);
                    ...
                    match l5 {
                        ...
                        1 => {
                            let e = {
                                ...
                                use super::super::super::wasi::keyvalue::store::Error as V10;
                                let v10 = match l6 {
                                    0 => V10::NoSuchStore,
                                    1 => V10::AccessDenied,
                                    n => {
            ...
            ///
            /// Other concurrent operations may also be able to see the partial results.
            pub fn delete_many(bucket: &Bucket, keys: &[_rt::String]) -> Result<(), Error> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 16]);
...
A\x08\x01B\x1c\x01q\x03\x0dno-such-store\0\0\x0daccess-denied\0\0\x05other\x01s\0\
...
0.2.0-draft\x05\0\x02\x03\0\0\x06bucket\x02\x03\0\0\x05error\x01B\x08\x02\x03\x02\
\x01\x01\x04\0\x06bucket\x03\0\0\x02\x03\x02\x01\x02\x04\0\x05error\x03\0\x02\x01\
h\x01\x01j\x01w\x01\x03\x01@\x03\x06bucket\x04\x03keys\x05deltaw\0\x05\x04\0\x09\
increment\x01\x06\x03\x01!wasi:keyvalue/atomics@0.2.0-draft\x05\x03\x01B\x13\x02\
\x03\x02\x01\x01\x04\0\x06bucket\x03\0\0\x02\x03\x02\x01\x02\x04\0\x05error\x03\0\
\x02\x01h\x01\x01ps\x01p}\x01o\x02s\x06\x01k\x07\x01p\x08\x01j\x01\x09\x01\x03\x01\
@\x02\x06bucket\x04\x04keys\x05\0\x0a\x04\0\x08get-many\x01\x0b\x01p\x07\x01j\0\x01\
\x03\x01@\x02\x06bucket\x04\x0akey-values\x0c\0\x0d\x04\0\x08set-many\x01\x0e\x01\
@\x02\x06bucket\x04\x04keys\x05\0\x0d\x04\0\x0bdelete-many\x01\x0f\x03\x01\x1fwa\
si:keyvalue/batch@0.2.0-draft\x05\x04\x04\x01\x1bcomponent:keyvalue/keyvalue\x04\
\0\x0b\x0e\x01\0\x08keyvalue\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
